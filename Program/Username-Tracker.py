...
try:
    ...
    print(f"\033[96m{current_time_hour()} {INFO} Selected User-Agent: {user_agent}\033[0m")
    username = input(f"\033[96m{current_time_hour()} {INPUT} Username -> \033[0m").lower()
    Censored(username)
    ...
    sites = {
        ...
        "Apple Discussions": {
            ...
            "method": "get",
            "verification": "status",
            "except": ["The page you tried was not found."]
        },
        "Hacker News": {
    ...
    print(f"\033[96m{current_time_hour()} {WAIT} Scanning..\033[0m")
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if found:
                        ...
                        print(f"\033[96m{current_time_hour()} {GEN_VALID} {site}: {url}\033[0m")
                    else:
                        print(f"\033[96m{current_time_hour()} {GEN_INVALID} {site}: Not Found\033[0m")

                else:
                    print(f"\033[96m{current_time_hour()} {GEN_INVALID} {site}: Not Found\033[0m")

            except Exception as e:
                print(f"\033[96m{current_time_hour()} {ERROR} {site}: Error: {e}\033[0m")
        except:
            pass

    if number_found > 0:
        print(f"\n\033[96mTotal Found:\033[0m")
        for site_and_url_found in sites_and_urls_found:
            for site, url in site_and_url_found.items():
                time.sleep(0.1)
                print(f"\033[96m────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────")
                print(f" {ADD} Name: {site}")
                print(f" {ADD} Link: {url}\033[0m")
        print(f"\033[96m────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\033[0m")

    print(f"\n\033[96m{current_time_hour()} {INFO} Total Website: {number_site} Total Found: {number_found}\033[0m")
    Continue()
    Reset()
